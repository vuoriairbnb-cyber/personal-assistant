...
import { dailyBriefGenerationRecord, persistsDeterministicStoryBriefings } from "./generation-contract";
...
test("live refresh creates zero deterministic Story Briefing rows", () => {

...
const sourceNames: Record<string, string> = { yle: "Yle", "bank-of-finland": "Bank of Finland", ecb: "European Central Bank", "pyn-elite": "PYN Elite", "vietnam-statistics": "National Statistics Office of Vietnam", "federal-reserve": "Federal Reserve", eurostat: "Eurostat", "statistics-finland": "Statistics Finland", "finance-ministry-finland": "Ministry of Finance Finland", riksbank: "Sveriges Riksbank", "norges-bank": "Norges Bank", "vietnam-government": "Vietnam Government Portal", "economic-affairs-finland": "Ministry of Economic Affairs and Employment Finland", bis: "Bank for International Settlements", "dg-ecfin": "European Commission DG ECFIN" };
...
async function ensureLiveSources(db: SupabaseClient<Database>) {
  const rows = [
    ...
    { slug: "statistics-finland", name: "Statistics Finland", base_url: "https://stat.fi", source_type: "official" as const, default_language: "en", enabled: true, default_content_type: "news" as const, metadata_json: { ...sourceMetadata("statistics-finland"), source_family: "official_primary_statistics", country: "Finland" } },
    { slug: "finance-ministry-finland", name: "Ministry of Finance Finland", base_url: "https://vm.fi", source_type: "official" as const, default_language: "en", enabled: true, default_content_type: "news" as const, metadata_json: { ...sourceMetadata("finance-ministry-finland"), source_family: "official_fiscal_policy", country: "Finland" } },
    { slug: "riksbank", name: "Sveriges Riksbank", base_url: "https://www.riksbank.se", source_type: "rss" as const, default_language: "sv", enabled: true, default_content_type: "news" as const, metadata_json: { ...sourceMetadata("riksbank"), source_family: "official_primary_policy", country: "Sweden" } },
    { slug: "norges-bank", name: "Norges Bank", base_url: "https://www.norges-bank.no", source_type: "rss" as const, default_language: "en", enabled: true, default_content_type: "news" as const, metadata_json: { ...sourceMetadata("norges-bank"), source_family: "official_primary_policy", country: "Norway" } },
    { slug: "vietnam-government", name: "Vietnam Government Portal", base_url: "https://en.baochinhphu.vn", source_type: "official" as const, default_language: "en", enabled: true, default_content_type: "news" as const, metadata_json: { ...sourceMetadata("vietnam-government"), source_family: "official_economic_policy", country: "Vietnam" } },
    { slug: "economic-affairs-finland", name: "Ministry of Economic Affairs and Employment Finland", base_url: "https://tem.fi", source_type: "official" as const, default_language: "en", enabled: true, default_content_type: "news" as const, metadata_json: { ...sourceMetadata("economic-affairs-finland"), source_family: "official_economic_policy", country: "Finland" } },
    { slug: "bis", name: "Bank for International Settlements", base_url: "https://www.bis.org", source_type: "rss" as const, default_language: "en", enabled: true, default_content_type: "long_read" as const, metadata_json: { ...sourceMetadata("bis"), source_family: "official_systemic_research" } },
    { slug: "dg-ecfin", name: "European Commission DG ECFIN", base_url: "https://economy-finance.ec.europa.eu", source_type: "official" as const, default_language: "en", enabled: true, default_content_type: "news" as const, metadata_json: { ...sourceMetadata("dg-ecfin"), source_family: "official_economic_policy", region: "Europe" } },
  ];
